...
export default function Home() {
  const links = [
    { name: 'Work at the USDA', url: 'https://plan.core-apps.com/pag_2024/abstract/385a5252b7c9b60b8795367ac6891809', internal: false },
    { name: 'More Projects', url: '/more-projects', internal: true },
  ];
  ...
  return (
    <main className="min-h-screen w-full bg-[#030303] text-zinc-300 flex flex-col items-center p-6 md:p-16 selection:bg-slate-700/50 relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="z-20 mt-4 mb-14 flex items-center space-x-3 bg-zinc-900/50 border border-zinc-800/80 rounded-full px-4 py-1.5 backdrop-blur-md"
      >
      ...
      <motion.div 
        ...
        className="flex flex-col items-center z-20 w-full max-w-4xl mb-24"
      >
        <h1 className={`${space.className} text-5xl md:text-7xl font-light leading-tight tracking-tighter text-slate-200 uppercase text-center`}>
          Henri<br/>Jenoudet
        </h1>
      ...
      <motion.div 
        ...
        className="z-20 w-full max-w-2xl text-center mb-20 bg-zinc-950/40 p-6 rounded-2xl border border-zinc-800/50 backdrop-blur-sm"
      >
